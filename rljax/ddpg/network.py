...
def build_ddpg_actor(state_shape, action_shape, rng_init, hidden_units=(400, 300)):
    """
...
def build_ddpg_critic(state_shape, action_shape, rng_init, hidden_units=(400, 300)):
    """
